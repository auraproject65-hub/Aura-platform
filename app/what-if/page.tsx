...
export default function WhatIfSimulator() {
  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <p className="text-gray-400">Adjust one variable and see how it changes your forecast.</p>
      <div className="glass-card space-y-4">
        ...
        <button onClick={runSimulation} className="btn-primary w-full">Simulate Impact</button>
      </div>
      {showResult && (
        <div className="glass-card space-y-2 animate-fadeIn">
          ...
          <p className="text-sm text-gray-400">Based on a 25% net margin assumption.</p>
        </div>
      )}
    </div>
  );
